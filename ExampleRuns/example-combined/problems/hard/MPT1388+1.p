%------------------------------------------------------------------------------
% File     : MPT1388+1 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : connsp_2__t13_connsp_2.p [MPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   34 (   8 unit)
%            Number of atoms       :  102 (  12 equality)
%            Maximal formula depth :   11 (   5 average)
%            Number of connectives :   74 (   6   ~;   1   |;  19   &)
%                                         (   5 <=>;  43  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   15 (   1 propositional; 0-3 arity)
%            Number of functors    :    7 (   1 constant; 0-2 arity)
%            Number of variables   :   62 (   0 sgn;  57   !;   5   ?)
