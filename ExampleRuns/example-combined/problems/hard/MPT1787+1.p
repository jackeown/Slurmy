%------------------------------------------------------------------------------
% File     : MPT1787+1 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : tmap_1__t102_tmap_1.p [MPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   52 (  18 unit)
%            Number of atoms       :  124 (  19 equality)
%            Maximal formula depth :   12 (   4 average)
%            Number of connectives :   81 (   9   ~;   1   |;  28   &)
%                                         (   4 <=>;  39  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   11 (   1 propositional; 0-2 arity)
%            Number of functors    :   14 (   2 constant; 0-3 arity)
%            Number of variables   :   92 (   2 sgn;  86   !;   6   ?)
